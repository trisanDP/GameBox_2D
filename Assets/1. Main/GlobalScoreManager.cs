...
public class GlobalScoreManager : MonoBehaviour {
    ...
    /// <summary>
    /// Clears all games' scores from memory and PlayerPrefs.
    /// </summary>
    ...
    /// <summary>
    /// Clears scores for a specific game.
    /// </summary>
...
/// <summary>
/// Base class for all score entries: contains common data.
/// </summary>
[Serializable]
...
/// <summary>
/// Number memory game-specific score entry.
/// </summary>
[Serializable]
...
/// <summary>
/// ColorClash (Stroop) game-specific score entry.
/// </summary>
[Serializable]
